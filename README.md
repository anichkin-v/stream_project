...
Проект разворачивается в `/home/web_deploy/web/public/stream` (владелец — пользователь
`web_deploy`). Document root Nginx указывает на вложенный каталог `public/`, то есть на
